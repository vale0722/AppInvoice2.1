                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block">
                            <img src="{{ asset('https://image.freepik.com/foto-gratis/concepto-escritorio-flat-lay-plantilla-portatil_23-2148111381.jpg')}}" width="450px" height="400px" class="img-login">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
